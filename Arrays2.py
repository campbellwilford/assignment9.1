...
print("-----------------------------------------------   STEP THREE  -----------------------------------------------")
sales_greater_than_100 = salesArray >= 100
print('Sales >= $100:', sales_greater_than_100)
print()

## Step 4: Print the total sales for each register.
print("-----------------------------------------------   STEP FOUR   -----------------------------------------------")
total_sales_per_register = np.sum(salesArray, axis=1)
print('Total Sales per Register:', total_sales_per_register)
print()
...
print("-----------------------------------------------   STEP FIVE  -----------------------------------------------")
credit_card_fee = 0.02 * salesArray
total_fees = np.sum(credit_card_fee)
print('Credit Card Fees:', credit_card_fee)
...
print("-----------------------------------------------   STEP SIX  -----------------------------------------------")
profit_per_sale = salesArray - credit_card_fee
print('Profit per Sale:', profit_per_sale)
print()

## Step 7: Print the sales only for the second and forth cash register
print("-----------------------------------------------   STEP SEVEN  -----------------------------------------------")
sales_register_2_and_4 = salesArray[[1, 3]]
print('Sales for Second and Fourth Register:', sales_register_2_and_4)
print()
...
print('Updated salesArray with the 5th Register:', salesArray)
print()
...
print("-----------------------------------------------   STEP NINE  -----------------------------------------------")
print('SalesArray Before Update:', salesArray)
salesArray[2, 3] = 20.14  
print('SalesArray After Update:', salesArray)
print()
